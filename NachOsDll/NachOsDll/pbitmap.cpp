...
PersistentBitmap::PersistentBitmap(OpenNaFile *file, int numItems):Bitmap(numItems) 
{ 
...
void
PersistentBitmap::FetchFrom(OpenNaFile *file) 
{
    file->ReadAt((char *)map, numWords * sizeof(unsigned), 0);
}
...
void
PersistentBitmap::WriteBack(OpenNaFile *file)
{
