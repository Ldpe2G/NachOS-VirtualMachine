...
//#define ConsoleInput	0	/*zhong_expan - */		//ConsoleInput,ConsoleOutput和ConsoleInput类,ConsoleOutput类
//#define ConsoleOutput	1							//的名字相同,这样会容易产生歧义

#define ConsoleInId		0	/*zhong_expan + */
#define ConsoleOutId	1
