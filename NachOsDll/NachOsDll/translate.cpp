...
/**** add
 * Liang DePeng + */
class  __declspec(dllexport) MyTranslationEntry: public TranslationEntry {
public:
	MyTranslationEntry(){}
	~MyTranslationEntry(){}
...
extern "C" {
	__declspec(dllexport) TranslationEntry* GetTranslationEntryF(){
		return new MyTranslationEntry;
	}

	__declspec(dllexport) void DeleteTranslationEntryF(TranslationEntry* tr){
		delete tr;
	}
}
/* Liang DePeng +
...
//have been moved to machine.cpp in MIPSVirtualMachine project
/**** delete
 * Liang DePeng - */
/*
//----------------------------------------------------------------------
